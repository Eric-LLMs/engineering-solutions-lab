    ...
    stages {
        ...
        stage('发布') {
            ...
            steps {
                script {
                    dir("ita") {
                        sh "ansible-playbook playbooks/data-center/push-direct.yml -e data_source=\"\$(pwd)/../code/output/kg/${params.type}\" -e data_dest=\"${cluster}/dict-service/dict/latest/kg/${params.type}\" -e datacenter=datacenter_acme -e delete_excluded=1"
