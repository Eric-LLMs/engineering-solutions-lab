...
pipeline {
    ...
    parameters {
        ...
        string name: 'passwd', defaultValue: '', trim: true, description: '服务器密码'
        ...
        stage('执行') {
            ...
            steps {
                script {
                    ...
                    dir('ita') {
                        sh "ansible-playbook playbooks/common-server/ssh-copy-id.yml -i ${params.hosts}, -e ssh_passwd=${params.passwd}"
                    }
                }
			}
        }
